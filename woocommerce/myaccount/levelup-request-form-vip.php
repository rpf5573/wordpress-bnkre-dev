<form id="levelup-request-form-vip" class="light-forms" method="POST" action="<?php echo admin_url( 'admin-post.php' ); ?>" novalidate autocomplete> <?php
  ...
  <div class="form-field">
    <div class="label-container">
      <label for="vip--location-info-agree">위치정보제공 동의</label>
    </div>
    <?php wc_get_template_part( 'myaccount/location-info', 'agree' ); ?>
    <div class="tb-space-10 d-flex middle">
      <span>동의하십니까?</span>
      <div class="checkbox md-checkbox ml-10">
        <input type="checkbox" name="location-info-agree" id="vip--location-info-agree" required>
        <label for="vip--location-info-agree"></label>
      </div>
