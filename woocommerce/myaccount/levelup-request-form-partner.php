<form id="levelup-request-form-partner" class="light-forms" method="POST" action="<?php echo admin_url( 'admin-post.php' ); ?>" novalidate autocomplete> <?php
  ...
  <input type="hidden" name="new-role" value="partner">
  <div class="form-field field-required">
    <div class="label-container">
      <label for="partner--user-name">성명</label>
      <span class="error-message">*성함을 입력해주시기 바랍니다</span>
    </div>
    <input id="partner--user-name" type="text" name="user-name" required>
  </div>
  <div class="form-field field-required">
    <div class="label-container">
      <label for="partner--register-purpose">가입목적</label>
      <span class="error-message">*가입목적을 선택해주시기 바랍니다</span>
    </div>
    <select name="register-purpose" id="partner--register-purpose" required>
  ...
  <div class="form-field">
    <div class="label-container">
      <label for="partner--personal-info-agree">개인정보제공 활용 동의</label>
    </div>
    ...
    <div class="tb-space-10 d-flex middle">
      ...
      <div class="checkbox md-checkbox ml-10">
        <input type="checkbox" name="personal-info-agree" id="partner--personal-info-agree" required>
        <label for="partner--personal-info-agree"></label>
      </div>
